<template>
          ...
          <v-card>
            <v-card-text class="text-left p-5">
                ...
                <div class="col-lg-12" v-if="paso == 1">
                    <form ref="form_paso_1" @submit.prevent="guardar_respuesta_personalidad('form_paso_1')">
                        <div class="row">
                                <div class="col-md-12">
                                    <div class="tab_menu">
                                        <div class="container">
                ...
                <div class="col-lg-12" v-if="paso == 2">
                    <form ref="form_paso_2" @submit.prevent="guardar_respuesta_personalidad('form_paso_2')">
                        <div class="row">
                                <div class="col-md-12">
                                    <div class="tab_menu">
                                        <div class="container">
                ...
                <div class="col-lg-12" v-if="paso == 3">
                    <form ref="form_paso_3" @submit.prevent="guardar_respuesta_personalidad('form_paso_3')">
                        <div class="row">
                                <div class="col-md-12">
                                    <div class="tab_menu">
                                        <div class="container">
                ...
                <div class="col-lg-12" v-if="paso == 4">
                    <form ref="form_paso_4" @submit.prevent="guardar_respuesta_personalidad('form_paso_4')">
                        <div class="row">
                                <div class="col-md-12">
                                    <div class="tab_menu">
                                        <div class="container">
                ...
                <div class="col-lg-12" v-if="paso == 5">
                    <form ref="form_paso_5" @submit.prevent="guardar_respuesta_personalidad('form_paso_5')">
                        <div class="row">
                                <div class="col-md-12">
                                    <div class="tab_menu">
                                        <div class="container">
                ...
                <div class="col-lg-12" v-if="paso == 6">
                    <form ref="form_paso_6" @submit.prevent="guardar_respuesta_personalidad('form_paso_6')">
                        <div class="row">
                                <div class="col-md-12">
                                    <div class="tab_menu">
                                        <div class="container">
                ...
                <div class="col-lg-12" v-if="paso == 7">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tab_menu">
                                <div class="container">
                                <div class="alert alert-success" role="alert">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <button @click="calificar_personalidad" class="btn btn-success" style="width: 100%;height: 100%; font-size: 28px; font-weight: bold;">Finalizar <br> Intento</button>
                                        </div>
                                    </div>
                                </div>
                                </div>
                ...
                <div class="col-lg-12" v-if="paso == 8">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tab_menu">
                                <div class="container">
  ...
  export default {
    ...
    methods: {
        ...
        async verificar_paso_personalidad(){
            await estudianteService.verificar_paso_personalidad(this.id_estudiante).then(respuesta => {
                this.paso = respuesta.data.paso;
                $('html, body').animate({scrollTop:400}, 1000); 
            });
        },
        async guardar_respuesta_personalidad(paso_form){
            ...
            await estudianteService.guardar_respuesta_personalidad(data).then(respuesta => {
